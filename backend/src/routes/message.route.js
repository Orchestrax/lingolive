...
import { sendMessage, getMessages, deleteMessage, editMessage } from "../controllers/message.controller.js";
...
router.put("/:messageId", isLoggedIn, upload.none(), editMessage);
